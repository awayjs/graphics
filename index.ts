...
export {AnimationNodeBase}				from "./lib/animators/nodes/AnimationNodeBase";
export {IAnimationSet}					from "./lib/animators/IAnimationSet";
export {IAnimator}						from "./lib/animators/IAnimator";
...
export {Sampler2D}						from "./lib/image/Sampler2D";
...
export {MappingMode}						from "./lib/textures/MappingMode";
