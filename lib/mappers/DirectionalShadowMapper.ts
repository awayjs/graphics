...
export class DirectionalShadowMapper extends ShadowMapperBase
{
	...
	constructor(image2D:Image2D = null)
	{
        ...
        this._image2D.mapper = this;

        this._textureMap = new Single2DTexture(this._image2D);
	...
	public dispose():void
	{
		...
		(<Single2DTexture> this._textureMap).image2D = null;
		this._textureMap = null;

		this._image2D.mapper = null;
		this._image2D = null;
	}
	...
	protected _renderMap(view:IView, renderer:IRenderer):void
	{
		...
		renderer._iRender(this._overallDepthProjection, view, this._image2D);
	}
